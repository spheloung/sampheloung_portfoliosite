        ...
        >
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold text-white mt-2 mb-4">Coromandel</h1>
                    <p className="text-xl text-slate-400">Coastal beauty</p>
                </motion.div>
                ...
                >
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
                        ...
                        <p className="text-slate-300 leading-relaxed">
                            The Coromandel Peninsula features stunning beaches, native bush, and the famous Cathedral Cove and Hot Water Beach.
                        </p>
                    </div>
