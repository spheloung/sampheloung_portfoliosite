        ...
        >
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold text-white mt-2 mb-4">Antarctica</h1>
                    <p className="text-xl text-slate-400">The frozen continent</p>
                </motion.div>
                ...
                >
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
                        ...
                        <p className="text-slate-300 leading-relaxed">
                            A photographic journey to the southernmost continent, capturing the raw beauty of ice, wildlife, and the endless white landscape.
                        </p>
                    </div>
