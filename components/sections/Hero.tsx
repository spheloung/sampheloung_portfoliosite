  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-32 md:pt-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-12 md:mt-24">
        ...
        >
          I build scalable systems, automate workflows, and optimize revenue engines for high-growth companies.
        </motion.p>
        ...
        >
          ...
          <Button variant="ghost" onClick={() => window.location.href = 'mailto:sam@example.com'}>
            Copy Email
          </Button>
        </motion.div>
      </div>
